       ...
       <div class="request_btn1"> <?php dynamic_sidebar('Request For Proposal'); ?></div> </div>
        ...
        <h1 class="prohecttitle">SELECT A PROJECT CATEGORY</h1>
          <ul>
              ...
              <li class="nomrgn icon4 service-active"><a href="http://www.rexindustries.com/custom/"><img src="<?php bloginfo('template_url'); ?>/img/thumb_pic4.jpg" alt=""><span><em>CUSTOM</em></span></a></li>
          </ul>
